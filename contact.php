...
<script>
  ...
  gtag('config', 'G-65YJM31BMV');
    ...
    <title>お問い合わせ｜NPO法人草津市心身障害児者連絡協議会</title>
    <meta name="description" content="草津市心身障害児者連絡協議会（児者連）へのお問い合わせ・ご相談はこちらから。障害福祉に関する支援内容、イベント参加、活動へのご質問など、お気軽にお寄せください。">
    <?php wp_head(); ?>
</head>
<body>
<header class="pc-header">
    <h1>
        <div class="header-logo">
            <a href="./index.php"><img src="./assets/images/logo.svg" alt="心身連"></a>
        </div>
    </h1>
    <nav class="pc-header__nav">
        <button class="primary-button"><a href="#">お問い合わせ</a></button>
        <ul>
            ...
            <div class="nav-grid__sections">
                <section class="nav-grid__section">
                    ...
                    <ul class="nav-grid__list">
                        <li><a href="./index.php" class="nav-grid__link">トップ</a></li>
