...
<main>
    ...
    <section class="contact-information">
        <ul class="contact-information__list">
            ...
            <li class="contact-information__list--item">
                <h2>受付時間</h2>
                <h3><img src="https://kusatsu-shinshinren.com/assets/images/i-clock.svg" alt="">電話・来所</h3>
    ...
    <section class="contact-form">
        <div class="contact-form__inner">
            <h2 class="contact-form__title">
                <img class="contact-form__icon" src="https://kusatsu-shinshinren.com/assets/images/i-form.svg" alt="">お問い合わせフォーム
            </h2>
