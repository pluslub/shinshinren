...
<!--                    <time class="date" datetime="2025-11-01"><?php echo get_the_date(); ?></time>-->
    ...
    <section class="related-posts">
        <div class="related-header">
            <h2>その他のお知らせ</h2>
            <button class="primary-button yellow-btn"><a href="https://kusatsu-shinshinren.com/news">お知らせ一覧</a></button>
        </div>
            ...
            <article class="related-item">
				...
				<div class="post-thumbnail">
					<?php if ( has_post_thumbnail() ) : ?>
						<?php the_post_thumbnail('full'); ?>
					<?php else : ?>
						<img src="https://kusatsu-shinshinren.com/assets/images/non-thumbnail.png">
					<?php endif; ?>
				</div>
				</a>
